// BROWSER CONSOLE SCRIPT FOR CREATING JOURNAL PAGES
// Instructions:
// 1. Log into the dashboard at http://localhost:3000/dashboard
// 2. Open browser console (F12 or Cmd+Option+I)
// 3. Paste this entire script and press Enter
// 4. The script will use your existing JWT token to create journal pages
...
async function createJournalEntry(entry) {
  try {
    ...
    if (!token) {
      console.error("❌ No JWT token found. Please log into the dashboard first.");
      return false;
    }
