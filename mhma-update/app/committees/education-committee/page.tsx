...
const committeeMembers: CommitteeMember[] = [
  ...
  },
  {
    ...
    image: "https://mhma.us/wp-content/uploads/2025/09/Oussama-Saafien-300-x-350.webp",
  },
  {
    name: "NAEEM BAIG",
    role: "COMMITTEE MEMBER",
...
export default function EducationCommitteePage() {
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto space-y-4">
              <p className="text-lg text-gray-700">
                <strong>Enriching Lives through continuous education.</strong>
              </p>
              <p className="text-gray-600">
                Since education is a fundamental tenant of out faith. The education committee is dedicated to creating opportunities for learners of all ages.
              </p>
              <p className="text-gray-600">
                Key educational programs run under the MHMA umbrella include the <a href="http://wish.mhma.info" target="_blank" rel="noopener noreferrer" className="text-[#c9a227] hover:underline">WISH</a> Sunday school program, the Urdu learning program, robotics, and STEM programs
              </p>
            </div>
          </div>
        </section>
