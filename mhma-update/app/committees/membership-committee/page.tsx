...
const committeeMembers: CommitteeMember[] = [
  {
    name: "ASAD SIDDIQUI",
    role: "COMMITTEE LEAD",
    image: "https://mhma.us/wp-content/uploads/2024/01/Asad-Siddiqui-300-x-350-e1724571795787.jpg",
  },
  {
    name: "MOHAMMAD BASHA",
    role: "COMMITTEE MEMBER",
    image: "https://mhma.us/wp-content/uploads/2024/01/Mohammad-Basha-300-x-350.jpg",
  },
  {
    name: "IMRAN KHAN LODHI",
    role: "COMMITTEE MEMBER",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <p className="text-lg text-gray-700">
                The MHMA Membership Committee is responsible for maintaining and growing MHMA membership
              </p>
            </div>
          </div>
        </section>
