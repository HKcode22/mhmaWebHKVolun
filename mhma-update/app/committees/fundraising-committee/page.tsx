...
export default function FundraisingCommitteePage() {
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <p className="text-lg text-gray-700">
                The MHMA Fundraising committee is responsible for all fundraising activity, and organizing fundraising events inside and outside of Mountain House.
              </p>
            </div>
          </div>
        </section>
