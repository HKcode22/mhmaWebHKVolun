          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <p className="text-lg text-gray-700">
                The MHMA Communications Committee is responsible for informing the community about the MHMA programs, events, and activities, utilizing all communication channels.
              </p>
            </div>
          </div>
        </section>
