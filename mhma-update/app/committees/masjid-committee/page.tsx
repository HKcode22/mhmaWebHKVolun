...
const committeeMembers: CommitteeMember[] = [
  ...
  },
  {
    name: "AYAN CHOUDHRY",
    role: "COMMITTEE MEMBER",
    image: "https://mhma.us/wp-content/uploads/2025/02/Aynan-Chaudhry.jpg",
  },
  {
    name: "ZAFAR KHAN",
    role: "COMMITTEE MEMBER",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <p className="text-lg text-gray-700">
                The MHMA Masjid Committee is responsible for the due diligence, design, and approval of Masjid plans.
              </p>
            </div>
          </div>
        </section>
