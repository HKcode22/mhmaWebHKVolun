          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <p className="text-lg text-gray-700">
                MHMA Events Committee is responsible for developing, organizing, scheduling, and executing all social activities for MHMA including but not limited to family nights, seminars, conferences, etc.
              </p>
            </div>
          </div>
        </section>
