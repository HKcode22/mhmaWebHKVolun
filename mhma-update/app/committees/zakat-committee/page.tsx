...
const committeeMembers: CommitteeMember[] = [
  ...
  },
  {
    name: "UMAR MUHAMMAD",
    role: "COMMITTEE MEMBER",
    image: "https://mhma.us/wp-content/uploads/2025/01/MU-1.webp",
  },
];

export default function ZakatCommitteePage() {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              <p className="text-lg text-gray-700">
                The MHMA zakat committee is responsible for managing the zakat donated by the community.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 px-4">
          <div className="max-w-6xl mx-auto text-center">
            <p className="text-gray-700">
              ...
              <a href="mailto:zakat@mhma.info" className="text-[#c9a227] hover:underline">
                zakat@mhma.info
              </a>
              . The zakat application can be{" "}
              <a
