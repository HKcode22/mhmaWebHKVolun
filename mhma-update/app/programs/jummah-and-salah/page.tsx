...
export default function JummahAndSalahPage() {
        ...
        <section className="py-0">
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-2/3 py-16 px-6 md:px-12 lg:px-16">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 uppercase mb-6">The Unity Center</h1>
              <div className="w-48 h-1 bg-[#c9a227] mb-8"></div>
              <div className="prose max-w-none">
                <p className="text-lg text-gray-700 mb-4">
                  The Unity Center is a facility owned by the City of Mountain House and managed by the Mountain House Muslim Association. The MHMA utilizes the facility for Jumma, Taraweeh, and many more activities throughout the year.
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/3 bg-gray-100 py-16 px-6 md:px-8">
              <div className="bg-white/50 p-8 mb-8">
                <div className="text-center mb-8">
                  <div className="text-5xl font-bold text-gray-800 mb-2">52</div>
                  <div className="text-gray-600 uppercase">Jumma per year</div>
                </div>
                <div className="text-center mb-8">
                  <div className="text-5xl font-bold text-gray-800 mb-2">650</div>
                  <div className="text-gray-600 uppercase">Worshipers</div>
                </div>
