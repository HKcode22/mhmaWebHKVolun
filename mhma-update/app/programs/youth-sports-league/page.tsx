            ...
            <div className="w-full lg:w-2/3 py-16 px-6 md:px-12 lg:px-16">
              ...
              <div className="prose max-w-none">
                <p className="text-lg text-gray-700 mb-4">
                  Teach your kids a healthy sport like soccer, basketball and volleyball.
                </p>
              </div>
            </div>
              ...
              <div className="bg-[#333] text-white p-6 rounded-lg">
                <div className="relative">
                  ...
                  <p className="text-white/90 italic mb-4 pt-4">
                    I love that my children are busy play a sport, making friends and keeping out of trouble.
                  </p>
