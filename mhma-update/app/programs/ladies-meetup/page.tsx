...
export default function LadiesMeetupPage() {
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-2/3 py-16 px-6 md:px-12 lg:px-16">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 uppercase mb-6">
                THE LADIES MEETUP IS A PROGRAM TO FACILITATE A WEEKLY GET TOGETHER OF SENIOR LADIES IN OUR COMMUNITY. A WELCOMING FUN FILLED EVENT WITH THE PERFECT COMBINATION OF ACTIVITY, SNACKS AND FOOD.
              </h1>
              <div className="w-48 h-1 bg-[#c9a227] mb-8"></div>
              <p className="text-gray-700 mb-4">
                Learn about one another, have some fun conversations, sip some delicious tea and enjoy the tasty snacks.
              </p>
            </div>
              ...
              <div className="bg-[#333] text-white p-6 rounded-lg">
                <div className="relative">
                  ...
                  <p className="text-white/90 italic mb-4 pt-4">
                    It is great to have the opportunity to meet with other like minded people, and that too over some delicious snacks.
                  </p>
                  <div className="text-4xl text-[#c9a227] absolute -bottom-2 -right-2">"</div>
                  <p className="font-semibold text-[#c9a227] mt-4">
                    Anonymous - Frequent attendee
                  </p>
                </div>
              </div>
            </div>
