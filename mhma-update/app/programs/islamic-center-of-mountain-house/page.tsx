...
export default function IslamicCenterOfMountainHousePage() {
  return (
        ...
        <section className="py-0">
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-2/3 py-16 px-6 md:px-12 lg:px-16">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 uppercase mb-6">Islamic Center of Mountain House</h1>
              <div className="w-48 h-1 bg-[#c9a227] mb-8"></div>
              <div className="prose max-w-none">
                <p className="text-lg text-gray-700 mb-4">
                  We have a GRAND Vision for the Islamic Center Of Mountain House to be a center of excellence for not just the people of Mountain House, but for the whole of Bay Area and Central Valley.
                </p>
                <p className="text-gray-700 mb-4">
                  An exceptional prayer hall, the "Masjid" will be at the center of this incredible facility. The Masjid will be surrounded by large multipurpose rooms to accommodate sports activities, large community events and much more.
                </p>
                <p className="text-gray-700 mb-4">
                  The campus will also include an educational center of excellence, a library, residential units and a commerce center that will generate the revenue to sustain the facility independent of external funds.
                </p>
                
                <h3 className="text-xl font-bold text-gray-800 uppercase mt-8 mb-4">Our Vision</h3>
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  <li>A state-of-the-art prayer facility</li>
                  <li>Multipurpose halls for community events</li>
                  <li>Educational center and library</li>
                  <li>Sports facilities for youth programs</li>
                  <li>Self-sustaining commercial spaces</li>
                </ul>

                <h3 className="text-xl font-bold text-gray-800 uppercase mt-8 mb-4">Location</h3>
                <p className="text-gray-700 mb-4">
                  250 East Main Street, Mountain House, CA 95391
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/3 bg-gray-100 py-16 px-6 md:px-8">
              <div className="bg-white/50 p-8 mb-8">
                <div className="text-center mb-8">
                  <div className="flex items-center justify-center text-5xl font-bold text-gray-800 mb-2">
                    <span className="mr-1">$</span><span>1,000,000</span>
                  </div>
                  <div className="text-gray-600 uppercase">Fundraising Target</div>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-gray-800 mb-2">0</div>
                  <div className="text-gray-600 uppercase">Sq Ft Planned</div>
                </div>
              </div>
              <div className="mb-8">
                <iframe
              ...
              <div className="bg-[#333] text-white p-6 rounded-lg">
                <div className="relative">
                  ...
                  <p className="text-white/90 italic mb-4 pt-4">The Unity Center has proven to be a game-changer for our community!</p>
                  <div className="text-4xl text-[#c9a227] absolute -bottom-2 -right-2">"</div>
                  <p className="font-semibold text-[#c9a227] mt-4">
                    SAQIB MALIK • TREASURER
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 px-4 bg-cover bg-center bg-fixed relative" style={{ backgroundImage: "url('https://mhma.us/wp-content/uploads/2016/08/home-footer.jpg')" }}>
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-white/90 text-lg mb-10 max-w-2xl mx-auto">
              Your donation helps us build the Islamic Center of Mountain House, creating a permanent home for our community.
            </p>
